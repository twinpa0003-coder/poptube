    ...
    <main>
      ...
      <div className="card">
        ...
        <ul>
          ...
          <li>재생 중 화면 우하단 버튼을 눌러 팝업으로 전환</li>
          <li>팝업 안에서는 영상 시청과 재생/일시정지를 사용할 수 있습니다</li>
        </ul>
      </div>
      ...
      <p>
        ...
        Google 정책상 임베디드 WebView 로그인은 지원되지 않습니다. PopTube의 라이브 채팅 로그인은 외부
        브라우저에서 Google OAuth를 진행한 뒤 앱의 채팅 패널에서 사용합니다.
      </p>
      <ol>
        <li>YouTube 앱에서 영상의 공유 버튼을 누릅니다.</li>
        <li>공유 대상에서 PopTube를 선택하면 로그인 없이 영상을 열 수 있습니다.</li>
        <li>일반적인 구독/재생목록 기능은 삼성 인터넷이나 Chrome에서 사용합니다.</li>
      </ol>
      ...
      <p className="note">
        PopTube가 여기서 더 해주는 것: 매번 수동으로 설정할 필요 없음, 수동 PiP, 알림 컨트롤, 광고 요청 차단,
        공유 인텐트 수신.
      </p>
